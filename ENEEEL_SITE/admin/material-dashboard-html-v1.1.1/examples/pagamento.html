	            ...
	            <div class="container-fluid">
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="red">
	                                <h4 class="title">Pacote selecionado</h4>
	                                <p class="category">Acompanhe todas as etapas de pagamento</p>
	                            </div>
	                ...
	                <div class="row">
	                    ...
	                    <div class="col-md-4">
	                        <div class="card">
	                            <div class="card-header" data-background-color="red">
	                                <h4 class="title">Pacote top</h4>
	                                <p class="category">R$370,00</p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table">
	                                    <thead class="text-primary">
	                                ...
	                                <center><button type="submit" class="btn btn-primary">Escolher</button></center>
